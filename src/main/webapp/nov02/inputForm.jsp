...
function openConfirmid(userId){
	alert(userId.id.value);
}
	...
	<form action="inputPro.jsp" name="serinput" onsubmit="return checkIt()" method="post">
		...
		<div id="body">
			<table width="500px;">
				...
				<tr>
					<th>E-Mail</th>
					<td><input type="text" name="e-mail" class="w300" maxlength="30" /></td>
				</tr>
				<tr>
					<th>Blog</th>
		...
		<div id="footer">
			<input type="submit" name="confirm" class="inputByn" value="등록" />
			<input type="reset" name="reset" class="inputByn" value="다시입력" />
			<input type="button" class="inputByn" value="취소" onclick="javascript:window.location='main.jsp'" />
		</div>		
	</form>
</div>
</body>
